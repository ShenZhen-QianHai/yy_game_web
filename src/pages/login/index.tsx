            ...
            <div className={`${logincss.main}`}>
                ...
                <div className={`${logincss.main_right}`}>
                    ...
                    <div className={`${logincss.main_right_from}`}>
                        ...
                        <div className={`${logincss.main_right_from_submit}`}
                                    onClick={handleLogin}>Log in</div>
                        <div className={`${logincss.main_right_from_item} ${logincss.main_right_from_item2}`}>
                            <div className={`${logincss.main_right_from_label}`}></div>
                            <div className={`${logincss.main_right_from_footer}`}>
                                <div className={`${logincss.main_right_from_footer_1}`} onClick={handleForget}>Forget password?</div>
                                <div className={`${logincss.main_right_from_footer_2}`} onClick={handleCreate}>Create an account</div>
                            </div>
                        </div>
                    </div>
                </div>
